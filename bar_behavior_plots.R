...
# -----------------------------------------------------------------------------
# Transitions & Bouts (extended fig 6)

# Load & clean transitions
...
# Sensor data (Lickometer, Food_nose_pokes, Wheel_cycles): t-test or one-way
# ANOVA depending on comparison (see paper for details).
